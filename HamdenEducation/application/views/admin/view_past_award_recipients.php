        ...
        <div class="main-content">
            <section class="section">
                <div class="row text-center mt-5 mb-3">
                    <h1 class="col">All Past Award Recipient</h1>
                </div>
                    ...
                    <div style="box-shadow: 1px 8px 20px grey;" class="card card-statistic-2">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Number of Past Award Recipients</h4>
                            </div>
                            <div class="card-body">
                                <?php echo count($awardRec['data']);?>
                            </div>
                        </div>
                    </div>
                </div> 
                                    ...
                                    foreach($awardRec['data'] as $row){
                                        echo '
                                            <tr>
                                                ...
                                                <td><a href="del_award_recipient/'.$row->recipients_id.' " class="btn btn-danger">delete <i class="fa fa-trash"></i></a></td> 
                                            </tr>
                                        ';
                                    }
                                    if(empty($awardRec['data'])){
                                        echo '<p class="text-primary text-center font-weight-normal"><i class="fa fa-exclamation-circle"></i> You currently have no Award Recipients, to create one click on the "forms" tab in the sidebar, then on "Create a Past Award Recipient"</p>';
                                    }
                                ?>
                            </tbody>
                        </table>
