      ...
      <div class="main-content">
        <section class="section">
           <div class="container shadow-lg p-3 mt-5 bg-white rounded">
             <h1 class="mt-3 text-center mb-3">Enter a Past Award Recipient</h1> 
            ...
            <div class="row justify-ccontent-center p-3">
              ...
              <div class="col-sm-12 col-lg-6 mt-4">
                    <label class="font-weight-bold form-label">Receiving Award Title</label>
            ...
            <div class="row justify-content-center p-3">
                <div class=" col-lg-12 col-sm-12 mt-4">
                    <label class="font-weight-bold form-label">Award Description</label>
            ...
            <div class="row m-3">
                <div class="col-md-6">
                    <button class="btn btn-lg" type="submit">Create Award Recipient</button>
                </div>
            </div>
            <?php echo form_close();?>
           </div>
