            ...
            <div class="row mt-sm-4">
                ...
                <div style="color: #265857; box-shadow: 1px 8px 20px grey;"class="card profile-widget">
                  <div class="profile-widget-header">
                    ...
                    <div class="profile-widget-description">
                      <div class="profile-widget-name m-3">
                        <?php echo $this->session->first_name. ' ' .$this->session->last_name;?> 
                          <div class="text-muted d-inline font-weight-normal">
                          <div class="slash"></div>
                            <?php echo $this->session->school_name; ?>
                      </div>
                    </div>
                  </div>
              ...
              <!--<div class="col-12 col-md-12 col-lg-7">--> 
                ...
                <div style="box-shadow: 1px 8px 20px grey;" class="card">
                  ...
                  <?php echo form_open('../index.php/Admin/Dash/update_profile');?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                          <div class="form-group col-lg-4 col-sm-12">
                            ...
                            <input type="text" readonly class="form-control" value="<?php echo $this->session->account_type;?>">
                          </div>

                          <div class="form-group col-lg-4 col-sm-12">
                            <label>Privilege</label>
                            <input type="text" readonly class="form-control" value="<?php echo $this->session->privilege;?>">
                          </div>

                          <div class="form-group col-lg-4 col-sm-12">
                            <label>Board Position</label>
                            <input type="text" readonly class="form-control" value="<?php echo $this->session->board_position;?>">
                          </div>
                        </div>
