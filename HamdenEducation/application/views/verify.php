...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img href="<?php echo base_url();?>index.php/Home/new_home" src="https://hamdeneducationfoundation.org/wp-content/uploads/2020/09/HEF-full-logo-2020.png" id="icon" alt="User Icon" />
    </div>
    ...
    echo form_open();
                  ...
                  echo $this->session->flashdata('guest_not_verified');
                  ?>
                
      <input type="text"  class="fadeIn second" name="code" placeholder="Enter the verification code">
      <small class="text-danger"><?php echo form_error('code');?></small>
      <input type="submit" class="fadeIn fourth mt-3" value="Verify">
    <?php echo form_close();?>
