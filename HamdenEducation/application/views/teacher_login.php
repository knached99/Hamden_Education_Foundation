...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      ...
      <h3 style="color: #26585;" class="mt-3 text-center">Teacher Login</h3>
    </div>
    ...
    echo form_open();
                  ...
                  echo $this->session->flashdata('verified');
    ...
    <div id="formFooter">
      ...
      <a class="underlineHover ml-3 mr-3" href="reset_teacher_pwd">Forgot Password?</a>
    </div>
