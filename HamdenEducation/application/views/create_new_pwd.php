...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <?php echo form_open();?>      
      <input type="password"  class="fadeIn second" name="pwd" placeholder="Create your new password">
      <small class="text-danger"><?php echo form_error('pwd');?></small>
      <input type="password" class="fadeIn third" name="confirm_pwd" placeholder="Confirm your new password">
      <small class="text-danger"><?php echo form_error('confirm_pwd');?></small>
      <input type="submit" class="fadeIn fourth mt-3" value="Update Password">
    <?php echo form_close();?>
